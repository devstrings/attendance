...
const ManagerList = () => {
  ...
  const [tableLoading, setTableLoading] = useState(false); // ✅ NEW: Separate loading for filtering
  
  // ✅ FIXED: Separate input and search term
  ...
  useEffect(() => {
    filterManagerList();
  }, [searchTerm, filterDepartment, filterStatus, managers]);

  // ✅ DEBOUNCE: Auto-search after 800ms
  useEffect(() => {
  ...
  const filterManagerList = () => {
    setTableLoading(true); // ✅ Show loading during filter
  ...
  const handleDelete = async (managerId, managerName) => {
    ...
    try {
      ...
      alert(error.message || 'Failed to delete manager. Please try again.');
    }
  };
                    ...
                    <tr key={manager._id}>
                      ...
                      <td>
                        <span className="employee-count">
                          {manager.employeesUnder?.length || 0} employees
                        </span>
                      </td>
                      ...
                      <td>
                        <div className="action-buttons">
                          <button
                            ...
                            onClick={() => navigate(`/admin/manager/${manager.navigationId}`)}
                            title="View Details"
                          >
                            👁️
                          </button>
                          ...
                          <button
                            ...
                            onClick={() => navigate(`/admin/edit-manager/${manager.navigationId}`)}
                            title="Edit"
                          >
                            ✏️
                          </button>
