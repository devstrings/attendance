...
const ManagerNotifications = () => {
  ...
  const fetchNotifications = async () => {
    try {
      setLoading(true);
      const token =
        localStorage.getItem("manager_token") || localStorage.getItem("token");

      const res = await fetch(
        `${API_URL}/notifications/my-notifications?limit=50`,
        {
          headers: {
  ...
  const handleBulkDelete = async () => {
    ...
    if (!window.confirm(`${selectedIds.length} notifications delete karo?`))
      return;
    try {
      const token =
        localStorage.getItem("manager_token") || localStorage.getItem("token");
  ...
  const handleSelectAll = () => {
    if (selectAll) {
      ...
      setSelectedIds(displayed.map((n) => n._id));
      setSelectAll(true);
    }
  };
          ...
          >
            ...
            <div style={{ padding: 24 }}>
              ...
              >
                <button
                  onClick={async (e) => {
                    await deleteNotification(selectedNotif._id, e);
          ...
          <div style={S.pageHeader}>
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div>
                ...
                <p style={S.pageSub}>
                  Admin updates, announcements, and your request status
                </p>
              </div>
            </div>
            {unreadCount > 0 && (
            ...
            <button
              ...
              style={{
                ...S.markAllBtn,
                background: selectAll ? "#ef4444" : "#f3f4f6",
                color: selectAll ? "white" : "#374151",
              }}
            >
          ...
          <div style={S.listCard}>
            {loading ? (
              ...
              <div style={S.emptyBox}>
                <div style={{ fontSize: 72, opacity: 0.25, marginBottom: 16 }}>
                  📭
                </div>
                <h3
                  style={{ color: "#374151", margin: "0 0 8px", fontSize: 18 }}
                >
                  {filter === "unread"
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        cursor:
                          deleting === notif._id ? "not-allowed" : "pointer",
                      }}
