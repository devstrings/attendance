  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (employeesRes?.success) {
        const emps =
          employeesRes.data?.employees || employeesRes.employees || [];
        ...
        <div className="manager-content" style={S.content}>
          ...
          <div style={S.statsGrid}>
            {[
              ...
              <div
                key={s.label}
                style={{ ...S.statCard, borderLeftColor: s.color }}
              >
          ...
          <div style={S.tableCard}>
            ...
            <div style={S.tableFooter}>
              ...
              <strong>{totalEmployees}</strong> total employees
            </div>
          </div>
        </div>
      </div>
