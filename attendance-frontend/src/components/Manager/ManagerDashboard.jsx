...
//             <h3>Quick Tips</h3>
//             <ul>
//               <li>📌 Mark attendance for your team members daily</li>
//               <li>📌 Review attendance history regularly</li>
//               <li>📌 Clock in/out to track your own attendance</li>
//             </ul>
//           </div>
//         </div>
//       </div>
        ...
        <div className="manager-content">
          ...
          <div className="quick-tips">
            ...
            <ul>
              ...
              <li>🏖️ <strong>Weekends:</strong> Saturday & Sunday (Off)</li>
              <li>⏰ <strong>Grace Period:</strong> 15 minutes for late arrival</li>
            </ul>
          </div>
        </div>
      </div>
