        ...
        <div className="admin-content" style={styles.content}>
          ...
          <div style={styles.header}>
            ...
            <div style={styles.headerActions}>
              <button style={styles.primaryButton} onClick={() => navigate('/manager/mark-attendance')}>
                <span>📝</span> Mark Attendance
              </button>
              <button style={styles.secondaryButton} onClick={() => navigate('/manager/my-employees')}>
          ...
          <div style={styles.statsGrid}>
            ...
            <div style={{ ...styles.statCard, borderLeftColor: '#3b82f6' }}>
              ...
              <div style={styles.statFooter}>
                <a href="#" style={styles.statLink}
                  onClick={(e) => { e.preventDefault(); navigate('/manager/my-employees'); }}>
                  View All →
                </a>
              </div>
            </div>
            ...
            <div style={{ ...styles.statCard, borderLeftColor: '#10b981' }}>
              ...
              <div style={styles.statFooter}>
                <a href="#" style={styles.statLink}
                  onClick={(e) => { e.preventDefault(); navigate('/manager/attendance-history'); }}>
                  View Details →
                </a>
              </div>
            </div>
            ...
            <div style={{ ...styles.statCard, borderLeftColor: '#f59e0b' }}>
              <div style={styles.statHeader}>
                <div style={{ ...styles.statIcon, background: '#f59e0b15' }}>📝</div>
                <div style={styles.statInfo}>
                  <div style={styles.statLabel}>PENDING LEAVES</div>
                  <div style={styles.statValue}>{dashboardData.stats.pendingLeaves}</div>
                </div>
              </div>
              <div style={styles.statFooter}>
                <a href="#" style={styles.statLink}
              ...
              <div style={styles.widgetContent}>
                ...
                <div style={styles.attendanceDetails}>
                  ...
                  <div style={styles.detailItem}>
                    ...
                    <span style={styles.detailText}>Pending Leaves: {dashboardData.stats.pendingLeaves}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div style={styles.widget}>
              ...
              <div style={styles.widgetContent}>
                <div style={styles.quickActionsList}>
                  ...
                  <div style={styles.quickActionItem} onClick={() => navigate('/manager/mark-attendance')}>
                    <div style={{ ...styles.actionIcon, background: '#10b98115', color: '#10b981' }}>📝</div>
                    <div style={styles.actionInfo}>
                      <div style={styles.actionTitle}>Mark Attendance</div>
                      <div style={styles.actionDesc}>Record today's attendance</div>
                    </div>
                    <div style={styles.actionArrow}>→</div>
                  </div>

                  <div style={styles.quickActionItem} onClick={() => navigate('/manager/clock-in-out')}>
                  ...
                  <div style={styles.quickActionItem} onClick={() => navigate('/manager/attendance-history')}>
              ...
              <table style={styles.table}>
                ...
                <tbody>
                  {recentAttendance.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="4" style={styles.noData}>No recent attendance records</td>
                    </tr>
                  )}
                </tbody>
              </table>
