...
const MyEmployees = () => {
  ...
  const fetchMyEmployees = async () => {
    try {
      ...
      if (attRes.success && attRes.data?.attendance) {
        const map = {};
        attRes.data.attendance.forEach((r) => {
          const empId = r.employeeId?._id || r.employeeId;
          if (empId) map[empId.toString()] = r;
        });
        ...
        <div className="manager-content">
          ...
          <div style={S.pageHeader}>
            ...
            <div style={S.countBadge}>
              Total:{" "}
              <strong style={{ color: "#667eea", marginLeft: 6 }}>
            ...
            <table className="data-table">
              <thead>
                <tr style={S.theadRow}>
                  ...
                  <th style={S.th}>Active Status</th>
  ...
  <td style={S.td}>
    {(() => {
      const att = todayAttendanceMap[employee._id?.toString()];
      if (!att) return <span style={S.badgeAbsent}>❌ Absent</span>;
      if (att.status === "leave" || att.status === "on-leave")
        return <span style={S.badgeLeave}>🏖️ On Leave</span>;
      if (att.status === "present")
        return <span style={S.badgePresent}>✅ Present</span>;
      return <span style={S.badgeAbsent}>❌ Absent</span>;
    })()}
  </td>
            ...
            <div style={S.summaryCard}>
              ...
              <div style={S.summaryGrid}>
                <div style={S.summaryItem}>
                  <div style={{ ...S.summaryIcon, background: "#10b98115" }}>
                    ✅
                  </div>
                  <div>
                ...
                <div style={S.summaryItem}>
                  <div style={{ ...S.summaryIcon, background: "#3b82f615" }}>
                    🏢
                  </div>
                  <div>
                ...
                <div style={S.summaryItem}>
                  <div style={{ ...S.summaryIcon, background: "#8b5cf615" }}>
                    👥
                  </div>
                  <div>
